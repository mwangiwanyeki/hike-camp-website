    ...
    <section className='flexCenter flex-col'>
      ...
      w-full pb-24'>
        ...
        <div className='flex flex-wrap justify-between gap-5 lg:gap-10'>
          <h2 className='bold-20 lg:bold-64 xl:max-w-[390px]'>
            ...
            <div className='flexBetween flex-col'>
              <div className='flex w-full flex-col'>
                <div className='flexBetween w-full '>
                  <p className='regular-16 text-gray-20 pr-10'>Destination</p>
                  <p className='bold-16 text-green-50'>53 min</p>
                </div>
                <p className='bold-20 mt-2'>Oloisare Dogoi</p>
              </div>

              <div className='flex w-full flex-col'>
                  <p className='regular-16 text-gray-20'>Start track</p>
                  <p className='bold-20 mt-2 whitespace-nowrap'>Olong'ate Sato</p>
              </div>
              </div>  
            </div>
        </div>
